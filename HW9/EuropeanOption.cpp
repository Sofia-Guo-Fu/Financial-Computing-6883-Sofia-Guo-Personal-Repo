...
EuropeanOption::EuropeanOption()
{
	...
	optType = "C"; // This is a default type
}

// New Created
EuropeanOption::EuropeanOption(double r_, double sig_, double K_, double T_, double U_, double q_, const char& optType_) 
{ 
	r = r_;
	sig= sig_;
	K = K_;
	...
	b = r_ - q_;			// Black and Scholes stock option model (1973)
	optType = &optType_;
}
