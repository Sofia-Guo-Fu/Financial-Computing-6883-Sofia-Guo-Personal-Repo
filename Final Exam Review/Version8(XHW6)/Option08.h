...
namespace fre{
    ...
    class OptionCalculation
    {
        ...
        public:
            ...
            // Original PriceByCRR function
            double PriceByCRR(const BinomialTreeModel & Model); 
            // rewrite the PriceByCRR function, four parameters 
            double PriceByCRR(const BinomialTreeModel &Model, BinLattice<double> &PriceTree,
