...
namespace fre{
    ...
    {
        // create an object of DifferenceOfOption called VarRedOpt
        ...
        delta = VarRedOpt.GetDelta() + CVOption.DeltaByBSFormula(Model); 
        
        PricingError = VarRedOpt.GetPricingError(); 
