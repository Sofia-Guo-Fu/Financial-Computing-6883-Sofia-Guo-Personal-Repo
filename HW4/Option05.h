...
namespace fre{
    ...
    {
        private:
            // the class OptionCaculation class has a pointer pointing to the base class EurOption
            /*the pointer will be associated with either the address of a Call object or Put Object 
            when an object of OptionCalculation is created*/
